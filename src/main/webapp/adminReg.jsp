		...
		<div class="row vh-100">
			<div class="col-md-6 align-self-center">
				<div class="w-50  m-auto">
					<h2 class="mb-2 text-center">Admin Registration</h2>
				<c:if test="${not empty adminRegFail}">
				<div class="alert alert-danger alert-dismissible fade show"
						role="alert">
						<strong>${adminRegFail}</strong>
						<button type="button" class="close" data-dismiss="alert"
							aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<c:remove var="adminRegFail" />
					</c:if>
					<form  action="adminRegister" method="post">
						...
						<div class="form-group mb-2">
							<label for="exampleInputPassword1">Phone number</label> <input
								name="phone" type="number" class="form-control" id="exampleInputNumber"
								placeholder="Phone number">
						</div>

						<div class="form-group row justify-content-center">
							<div class="col-md-auto">
								<a href="admin.jsp">Already have an account?</a>
							</div>
						</div>
