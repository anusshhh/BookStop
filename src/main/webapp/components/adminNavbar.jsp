	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active mb-2"><a class="nav-link"
				href="../dashboard"><i class="fas fa-home"></i> Home <span
					class="sr-only">(current)</span> </a></li>
			<li class="nav-item active"><a class="nav-link"
				href="../adminLibrary?pageNo=0&query="><i class="fas fa-eye"></i> Library</a></li>
			<li class="nav-item active"><a class="nav-link"
				href="../records"><i class="fas fa-book-open"></i> Issue
					Books</a></li>
			<li class="nav-item active"><a class="nav-link"
				href="../history"><i class="fas fa-history"></i> History</a></li>
			...
			<li class="nav-item dropdown ">
				<div class="btn-group">
					<button type="button" class="btn btn-outline-light">
						<i class="fas fa-user"></i> Hello, Admin
					</button>
					<button type="button"
